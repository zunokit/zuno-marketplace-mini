...
export const CONTRACT_ADDRESSES = {
  ...
  11155111: {
    // Core Marketplace
    NFT_EXCHANGE_REGISTRY: process.env.NEXT_PUBLIC_NFT_EXCHANGE_REGISTRY_SEPOLIA || "",
    COLLECTION_FACTORY_REGISTRY: process.env.NEXT_PUBLIC_COLLECTION_FACTORY_REGISTRY_SEPOLIA || "",
    ...
    LISTING_HISTORY_TRACKER: process.env.NEXT_PUBLIC_LISTING_HISTORY_TRACKER_SEPOLIA || "",
    ...
    COLLECTION_VERIFIER: process.env.NEXT_PUBLIC_COLLECTION_VERIFIER_SEPOLIA || "",
