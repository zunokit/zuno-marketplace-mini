...
export {
  ...
  ExchangeRegistry_ABI,
  CollectionRegistry_ABI,
  AuctionRegistry_ABI,
  FeeRegistry_ABI,
...
export const ABIS = {
  ...
  DutchAuction: DutchAuction_ABI,
  BundleManager: BundleManager_ABI,
  OfferManager: OfferManager_ABI,
  ERC721Collection: ERC721Collection_ABI,
  ERC1155Collection: ERC1155Collection_ABI,
  ERC721CollectionFactory: ERC721CollectionFactory_ABI,
  ERC1155CollectionFactory: ERC1155CollectionFactory_ABI,
  ExchangeRegistry: ExchangeRegistry_ABI,
  CollectionRegistry: CollectionRegistry_ABI,
  AuctionRegistry: AuctionRegistry_ABI,
  FeeRegistry: FeeRegistry_ABI,
